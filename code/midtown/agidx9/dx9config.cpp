...
static constexpr const char* kConfigTemplate =
    ...
    "smoothnormals = 1\n"
    "; Where vertex normals come from. Most city meshes were shipped with none, and the rest store one of\n"
    "; only 198 directions per corner - and RTX Remix lights every surface from these. 0 = as shipped\n"
    "; (straight up where missing), 1 = rebuild the missing ones from the geometry, 2 = rebuild them all.\n"
    "geonormals = 2\n"
    "; For the rebuild: faces meeting at a sharper angle than this, in degrees, keep a hard edge.\n"
    "geonormalangle = 45\n"
    "\n"
    "[Performance]\n"
    "; Keep the city's geometry on the graphics card between frames instead of rebuilding it and sending\n"
    "; it again every frame. Only turn this off to compare, or if something draws wrong with it on.\n"
    "d3d9meshcache = 1\n"
    "; Memory the cache may use, in MB. When full it drops the meshes drawn least recently.\n"
    "d3d9meshcachemb = 64\n"
    "\n"
    "[Debug]\n"
